...
Element.prototype.matches ||
  ...
  (function (e, t) {
    ...
    function (e) {
      "use strict";
      var t = { idPrefix: "tabby-toggle_", default: "[data-tabby-default]" },
        r = function (t) {
                ...
                return (
                  ...
                  o
                    ? (o.setAttribute("hidden", "hidden"),
                      { previousTab: r, previousContent: o })
                    : { previousTab: r }
                );
              })(t);
              !(function (e, t) {
        ...
        o = function (e, t) {
          var o = (function (e) {
            ...
            if (r)
              return { tabs: r, index: Array.prototype.indexOf.call(r, e) };
          })(e);
          if (o) {
            var n,
              i = o.tabs.length - 1;
            ["ArrowUp", "ArrowLeft", "Up", "Left"].indexOf(t) > -1
              ? (n = o.index < 1 ? i : o.index - 1)
              : ["ArrowDown", "ArrowRight", "Down", "Right"].indexOf(t) > -1
              ? (n = o.index === i ? 0 : o.index + 1)
              : "Home" === t
              ? (n = 0)
              : "End" === t && (n = i),
              r(o.tabs[n]);
      ...
      return function (n, i) {
        ...
        (u.destroy = function () {
          ...
          Array.prototype.forEach.call(e, function (e) {
            ...
            l.removeEventListener("keydown", s, !0),
            (a = null),
            (l = null);
        }),
          (u.setup = function () {
          ...
          (function (t) {
            if (!(e.location.hash.length < 1)) {
              var o = document.querySelector(
                t + ' [role="tab"][href*="' + e.location.hash + '"]'
              );
              r(o);
            }
          })(n),
